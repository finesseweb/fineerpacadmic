...
class manufacturing_app extends application
{
	function __construct()
	{
        ...
        $this->add_lapp_function(2, _("&Group of System"),
			"manufacturing/manage/group_center.php?", 'SA_BOM', MENU_ENTRY);
             $this->add_lapp_function(2, _("&Group name"),
			"manufacturing/manage/group_name.php?", 'SA_BOM', MENU_ENTRY);
		$this->add_lapp_function(2, _("&Work Centres"),
			"manufacturing/manage/work_centres.php?", 'SA_WORKCENTRES', MENU_MAINTENANCE);
                
              $this->add_lapp_function(2, _("&Manufactured Items"),
			"manufacturing/manage/manufactured_items.php?", 'SA_WORKCENTRES', MENU_MAINTENANCE);
