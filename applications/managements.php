...
class managements_app extends application
{
	function __construct()
	{
		...
		$this->add_lapp_function(0, _("Floor"),
			...
			$this->add_lapp_function(2, _("Stock  Manage"),
			"manufacturing/stock_manage.php?NewProduct=Yes", 'SA_ASSEMBLE_ASSETS', MENU_TRANSACTION);
		 
                    $this->add_lapp_function(2, _("Item Returned"),
			"manufacturing/item_retrun.php?NewProduct=Yes", 'SA_ASSEMBLE_ASSETS', MENU_TRANSACTION);
		    $this->add_lapp_function(2, _("Group Released"),
			"manufacturing/group_return.php?NewProduct=Yes", 'SA_ASSEMBLE_ASSETS', MENU_TRANSACTION);
                    $this->add_lapp_function(2, _("Manufactured Item Retrun"),
			"manufacturing/manufact_return.php?NewProduct=Yes", 'SA_ASSEMBLE_ASSETS', MENU_TRANSACTION);
                    $this->add_lapp_function(2, _("Group Item Retrun"),
			"manufacturing/grp_item_return.php?NewProduct=Yes", 'SA_ASSEMBLE_ASSETS', MENU_TRANSACTION);
