...
$sql="SELECT freq.freq_id AS freq_id,freq.frequency_name AS frequency FROM ".TB_PREF."frequency_master AS freq WHERE freq.freq_id=".$utility_id."";
  $res = db_query($sql);
     echo "<option>--Select Frequency--</option>";
