...
$sql="INSERT INTO ".TB_PREF."breakdown_maintenance(utility_id,maintain_date,contractor_id,break_st_time,break_end_time,ob_reason,ob_1,ob_2,cat_id,sub_cat_id) VALUES('$utility_id','$maintain_date','$contractor_id','$break_st_time','$break_end_time','$ob_reason','$ob_1','$ob_2','$cat_id','$sub_cat_id')";
...
$ob_2 = $_POST["ob_2"];
$id = $_POST["break_id"];
$sql="UPDATE ".TB_PREF."breakdown_maintenance SET utility_id='$utility_id',maintain_date='$maintain_date',contractor_id='$contractor_id',break_st_time='$break_st_time',break_end_time='$break_end_time',ob_reason='$ob_reason',ob_1='$ob_1',ob_2='$ob_2',cat_id='$cat_id',sub_cat_id='$sub_cat_id' where break_id='$id'";
