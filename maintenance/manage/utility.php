...
{
	custom_list_cell($label, $name, $selected_id,$submit_on_change,$disable,$dd_type);
...
if(list_updated('type')){
 ...
 //custom_list_row(_("Return"), 'return_type', null, TRUE, false, 'product_return_type');
stock_categories_list_row(_("Category:"), 'category_id', null, false, true);
$category_id = $_POST['category_id'];
//$category_id = $_POST['return_type'];
