...
$selected_id  = $_POST['selected_id'];
   ...
   ///echo $selected_id; die();
    if($selected_id){
             $query = "SELECT prev.*,con.supp_name AS contractor FROM ".TB_PREF."process_maintenance AS prev LEFT JOIN ".TB_PREF."utility AS utly ON utly.id= prev.utility_id  LEFT JOIN ".TB_PREF."contractor con ON con.supplier_id= prev.contractor_id WHERE utly.type=2 and prev.process_id = $selected_id";
