...
function handle_new_item()
{
 ...
 if ($Mode == 'Edit') {
    $result = db_fetch(get_user_master_id($selected_id));
     $_POST['department_id']=$result['department_id'];
 ...
 if ($Mode == 'Delete')
{
	...
	//{
		delete_wo_user($selected_id);
		display_notification(_('Selected Group has been Release'));
	//}
	$Mode = 'RESET';
}
//-----------------------------------------------------------------------------------------------
...
department1_options_controlsm($selected_id);
